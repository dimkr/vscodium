...
if [[ "$TRAVIS_OS_NAME" == "osx" ]]; then
  ...
  if [[ $BUILDARCH == "arm64" ]]; then
    ...
    apt-get download libx11-dev:arm64 libx11-6:arm64 libxkbfile-dev:arm64 libxkbfile1:arm64 libxau-dev:arm64 libxdmcp-dev:arm64 libxcb1-dev:arm64 libsecret-1-dev:arm64 libsecret-1-0:arm64 libpthread-stubs0-dev:arm64
